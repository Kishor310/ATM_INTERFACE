...
class BankAccount {
    ...
    Scanner sc = new Scanner(System.in);
    double balance = 25000.00; // Initial balance
    ...
    public void withdraw() {
        ...
        try {
            ...
            if (withdrawAmount > balance) {
                ...
                System.out.println("\nAmount Withdrawal Successfully.Available balance: " + balance + "\n");
                String str = withdrawAmount + " Rs Withdrawed\n";
                transactionHistory = transactionHistory.concat(str); // Get Transaction history
